...
namespace Utils {
    internal class ConfigValue(JsonElement defaultValue) {
        ...
        public int GetAsInt() {
            ...
            throw new InvalidCastException($"无法将配置值 '{GetAsString()}' 转换为 int。");
        }
        public bool GetAsBool() {
            ...
            throw new InvalidCastException($"无法将配置值 '{GetAsString()}' 转换为 bool。");
        }
        /// <summary>
